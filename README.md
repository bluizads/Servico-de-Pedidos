# Servico de Pedidos em Memória
Construindo o núcleo de um servico de pedidos para uma loja
...
Um produto precisa exibir seu nome, saber seu preco e controlar o estoque.
...
Uma dica importante: valide tudo que puder antes de alterar estoque. 

## Geracao de IDs

Para simplificar, os IDs podem ser gerados em memoria. Nao precisa usar UUID nem pacote externo.
